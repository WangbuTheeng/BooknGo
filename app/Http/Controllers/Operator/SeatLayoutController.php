...
class SeatLayoutController extends Controller
{
    public function configure(Bus $bus)
    {
        ...
        $bus->load('seats');
        return view('operator.buses.layout.configure', compact('bus'));
    }
    ...
    public function store(Request $request, Bus $bus)
    {
        ...
        try {
            ...
            return redirect()->route('operator.buses.layout.preview', $bus)
    ...
    public function preview(Bus $bus)
    {
        ...
        return view('operator.buses.layout.preview', compact('bus', 'layoutSummary'));
    }
    ...
    public function reset(Bus $bus)
    {
        ...
        try {
            ...
            return redirect()->route('operator.buses.index', $bus)
