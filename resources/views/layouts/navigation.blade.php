            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @if(Auth::user()->isAdmin())
                        ...
                        <x-nav-link :href="route('admin.operators.index')" :active="request()->routeIs('admin.operators.*')">
                            {{ __('Operators') }}
                        </x-nav-link>
                    @endif
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @if(Auth::user()->isAdmin())
                ...
                <x-responsive-nav-link :href="route('admin.operators.index')" :active="request()->routeIs('admin.operators.*')">
                    {{ __('Operators') }}
                </x-responsive-nav-link>
            @endif
        </div>
