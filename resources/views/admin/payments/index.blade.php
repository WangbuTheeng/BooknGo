...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - Payment Management</title>
                ...
                <div class="flex items-center justify-between">
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">View and manage all system payments</p>
                        </div>
                    </div>
                    <div class="flex items-center space-x-3">
                        <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800">
                            Rs. {{ number_format($totalRevenue, 2) }} Total Revenue
                        </span>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">Rs. {{ number_format($completedPayments, 2) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">Rs. {{ number_format($pendingPayments, 2) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">Rs. {{ number_format($failedPayments, 2) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-5 w-0 flex-1">
                                <dl>
                                    ...
                                    <dd class="text-lg font-medium text-gray-900">Rs. {{ number_format($todayRevenue, 2) }}</dd>
                                </dl>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg mb-6">
                ...
                <form method="GET" action="{{ route('admin.payments.index') }}" class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
                        ...
                        <div>
                            <label for="payment_status" class="block text-sm font-medium text-gray-700 mb-2">Status</label>
                        ...
                        <div>
                            <label for="payment_method" class="block text-sm font-medium text-gray-700 mb-2">Method</label>
                                ...
                                <tr class="hover:bg-gray-50">
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        ...
                                        @if($payment->gateway_transaction_id)
                                            <div class="text-xs text-gray-500">Gateway: {{ $payment->gateway_transaction_id }}</div>
                                        @endif
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <div class="flex-shrink-0 h-8 w-8">
                                                <div class="h-8 w-8 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
                                                    <span class="text-white font-medium text-xs">{{ substr($payment->user->name, 0, 1) }}</span>
                                                </div>
                                            </div>
                                            <div class="ml-3">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <div class="text-sm text-gray-900">{{ $payment->booking->booking_reference }}</div>
                                        <div class="text-sm text-gray-500">
                                            {{ $payment->booking->trip->route->fromCity->name }} → {{ $payment->booking->trip->route->toCity->name }}
                                        </div>
                                    </td>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium 
                                            {{ $payment->payment_method === 'esewa' ? 'bg-green-100 text-green-800' : 
                                               ($payment->payment_method === 'khalti' ? 'bg-purple-100 text-purple-800' : 
                                                ($payment->payment_method === 'bank_transfer' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-800')) }}">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        <a href="{{ route('bookings.show', $payment->booking) }}" 
                                           class="text-blue-600 hover:text-blue-900">View Booking</a>
