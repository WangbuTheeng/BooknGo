    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <a href="{{ route('operator.booking.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-150 ease-in-out">
                    ...
                    <div>
                        <div class="font-medium text-gray-900">Counter Booking</div>
                        <div class="text-sm text-gray-600">Book tickets for customers</div>
                    </div>
                </a>
                
                <a href="{{ route('operator.booking.customer-bookings') }}" class="flex items-center p-4 border-2 border-blue-300 bg-blue-50 rounded-lg hover:bg-blue-100 transition duration-150 ease-in-out">
                    <svg class="w-8 h-8 text-blue-600 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z"></path>
                    </svg>
                    <div>
                        <div class="font-medium text-blue-900">Customer Bookings</div>
                        <div class="text-sm text-blue-700">View & manage all customer bookings</div>
                    </div>
                </a>
                ...
                <a href="{{ route('bookings.index') }}" class="flex items-center p-4 border border-gray-200 rounded-lg hover:bg-gray-50 transition duration-150 ease-in-out">
                    ...
                    <div>
                        <div class="font-medium text-gray-900">All Bookings</div>
