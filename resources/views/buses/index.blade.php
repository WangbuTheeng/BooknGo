...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Bus Management | BooknGo</title>
        <meta name="description" content="Manage your bus fleet - view, add, edit and delete buses">
            ...
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="flex justify-between items-center h-16">
                    <div class="flex items-center">
                        ...
                        <span class="ml-2 text-sm text-gray-500">Bus Management</span>
                    </div>
